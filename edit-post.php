                ...
                <div class="col-lg-8 col-md-10 mx-auto">
                    ...
                    <form method="POST" action="update-data.php">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="<?php echo $detail['judul'] ?>" id="title" name="title" required="required">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="author" class="col-sm-2 col-form-label">Author</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="<?php echo $detail['author'] ?>" id="author" name="author" required="required">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="datetime" class="col-sm-2 col-form-label">Tanggal</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="datetime" value="<?php echo $detail['tanggal'] ?>" name="datetime" required="required">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="content" class="col-sm-2 col-form-label">Konten</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="content" name="content" rows="8" required="required"> <?php echo $detail['content'] ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
