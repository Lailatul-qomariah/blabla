...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="index.php">172410101031</a>
  ...
  <article>
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <?php 
           echo"<a href='edit-post.php?id=". $detail['id']. "' class='btn btn-primary'>EDIT</a>";
           echo"<a href='delete-data.php?id=". $detail['id']. "' class='btn btn-danger'>HAPUS</a>";
           ?>
          <p>
            <?php
            echo $detail['content'];
